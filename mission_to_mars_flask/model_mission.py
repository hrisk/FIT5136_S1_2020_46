...
class Mission(db.Model):
    ...
    mission_type = db.Column(db.Text, nullable=False)
    ...
    mission_occupations = db.Column(db.String(30), nullable=False)
    mission_skills = db.Column(db.String(15), nullable=False)
    mission_language_required = db.Column(db.String(20), nullable=False)
    mission_secondary_language = db.Column(db.String(40), nullable=False)
    mission_cargo_for = db.Column(db.String(40), nullable=False)
    mission_cargo_requirements = db.Column(db.Text, nullable=False)
